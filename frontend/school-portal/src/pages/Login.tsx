...
import { setToken, setUser, setLicenseExpired } from '../store/authSlice';
  ...
  const handleLogin = async (values: { email: string; password: string }) => {
    try {
      ...
      if (detail === 'LICENSE_EXPIRED') {
        dispatch(setLicenseExpired(true));
        ...
        <div style={styles.brandingContent}>
          ...
          <div style={styles.featureList}>
            <div style={styles.featureItem}>
              ...
              <Text style={styles.featureText}>Complete student management system</Text>
            </div>
            <div style={styles.featureItem}>
              <div style={styles.featureIcon}>
                <span style={styles.checkmark}>✓</span>
              </div>
              <Text style={styles.featureText}>Attendance & Grade tracking</Text>
            </div>
            <div style={styles.featureItem}>
              <div style={styles.featureIcon}>
                <span style={styles.checkmark}>✓</span>
              </div>
              <Text style={styles.featureText}>Financial & Fee management</Text>
            </div>
            <div style={styles.featureItem}>
              <div style={styles.featureIcon}>
                <span style={styles.checkmark}>✓</span>
              </div>
              <Text style={styles.featureText}>Comprehensive reporting & analytics</Text>
            </div>
          </div>
        </div>
