...
def upgrade() -> None:
    op.execute("CREATE TYPE IF NOT EXISTS eventtype AS ENUM ('holiday', 'exam', 'event', 'meeting', 'workshop', 'sports', 'other')")
    ...
    op.create_table(
        ...
        sa.Column('event_type', sa.Enum('holiday', 'exam', 'event', 'meeting', 'workshop', 'sports', 'other', name='eventtype', create_type=False), nullable=False, server_default='event'),
